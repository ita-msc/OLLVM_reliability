...
# ------------------------------------------------------------------------------------------------------------------------------------
# This script intends to assess the performance of the obfuscator with and without the obfuscation activated
# includes the prog running
# ------------------------------------------------------------------------------------------------------------------------------------
...
# ----some piece of code that might be useful afterwards------------------
# arguments = []
# if (len(sys.argv)>1):
#     for i in range(2,len(sys.argv)):
#         arguments.append(str(sys.argv[i]))
#     r2 = r2pipe.open(str(sys.argv[1]), arguments)   
# else:
#     r2 = r2pipe.open(str(sys.argv[1]))   
# ----some piece of code that might be useful afterwards------------------
